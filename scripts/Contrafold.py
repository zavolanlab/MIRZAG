...
argparser.add_option('--contextLen_L', type=int, dest='contextLen_L',
                     default=0,
                     action='store', help='length of the \
                     context sequence downstream binding site to be unwinded')
argparser.add_option('--contextLen_U', type=int, dest='contextLen_U',
                     default=0,
                     action='store', help='length of the \
                     context sequence upstream binding site to be unwinded')
argparser.add_option('--context', type=int, dest='context',
                     default=50,
                     action='store', help='length of the \
